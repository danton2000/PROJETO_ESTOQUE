...
<body>
	...
	<div class="container" id="tamanho_container_tab"><!-- colocar os espaçamentos ficando esponsivo-->
		...
		<table class="table" id="topo_tabela">
  			<thead>
    			<tr>
      				<th scope="col">Nome do Fornecedor</th><!-- col = coluna -->
    			...
    			<tr>
      				<td><?php echo $nome_fornecedor ?></td><!--th = células(linha+colunas preenchidas) -->		
      				<td>
					  	<?php
						...
						?>
					<a class="btn btn-sm" id="botao_editar" href="editar_fornecedor.php?id=<?php echo $id_fornecedor ?>" role="button"><i class="far fa-edit"></i>&nbsp;Editar</a><!--&nbsp = espaço do icone;  i class = icone edit;
					?id = <?php echo $id_estoque ?> = pego o produto pelo id -->
						...
						?>	
                 	<a class="btn btn-sm" id="botao_deletar" href="deletar_fornecedor.php?id=<?php echo $id_fornecedor ?>" role="button"><i class="far fa-trash-alt"></i></i>&nbsp;Deletar</a> 
						<?php } ?>
					</td>
    			</tr>
  			   	<?php } ?>
