...
<div class="container" id="tamanho_container"><!-- distancia do topo de:40px -->
	...
	<form id="espaçamento" action="inserir_produto.php" method="POST"><!-- Enviar uma informação = POST,Pegar um valor = GET --> <!--distancia de 20px do form -->

  		<div class="form-group">
    		<label>N° do Produto</label>
    		<input type="number" class="form-control" name="nro_produto" placeholder="Insira o numero do produto"required>
    	</div>

    	<div class="form-group">
    		<label>Nome do Produto</label>
    		<input type="text" class="form-control" name="nome_produto" placeholder="Insira o nome do produto" required autocomplete="off"><!--required = não pode ser em branco --> <!-- autocomplete="off" = não salva os nomes -->
    	</div>
    	...
    	<div class="form-group">
  		...
  		<div id="botao_direita">
  		<button type="submit" id="botao_cadastrar" class="btn btn-sm">Cadastrar</button><!--submit = enviar as informações -->
      </div>    
